            ...
            {step === 1 && (
              <div>
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full mt-4 flex items-center justify-center gap-3 py-3 bg-white border border-gray-300 rounded-xl text-navy font-semibold hover:bg-gray-50 transition-all disabled:opacity-50"
                >
                  <GoogleIcon />
